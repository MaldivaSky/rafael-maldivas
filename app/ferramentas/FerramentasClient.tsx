...
export const copy = {
  "pt": {
    ...
    "h1a": "Ferramentas para ",
    "h1b": "usar no dia a dia.",
    "lead": "Calcule custos, consulte informações e prepare imagens. Você pode usar as ferramentas sem cadastro e sem deixar seu e-mail.",
    "priceTitle": "Calculadora de preço de venda e CMV",
    "priceLead": "Vender bem e quebrar ao mesmo tempo é comum: quase todo mundo sabe o faturamento, quase ninguém sabe a margem. Preencha o custo do prato e descubra o preço que fecha a margem que você quer.",
    ...
    "mailLead": "Se o seu domínio não tem SPF, DKIM e DMARC configurados, sua proposta comercial tem grande chance de cair no spam do cliente — e você nunca fica sabendo. Digite o domínio e veja em segundos.",
    ...
    "ctaMail": "Quer isso corrigido sem você mexer em DNS? Configuração de SPF, DKIM e DMARC está dentro do pacote de gestão de e-mail corporativo.",
    "ctaPrice": "Quer esse cálculo automático, por prato e ligado ao seu estoque? É exatamente o que o MiseOn faz.",
  ...
  "en": {
    ...
    "h1a": "Tools for ",
    "h1b": "everyday work.",
    "lead": "Calculate costs, look up information and prepare images. No account or email required.",
    "priceTitle": "Selling price & food-cost calculator",
    "priceLead": "Selling well and going broke at the same time is common: almost everyone knows revenue, almost nobody knows margin. Enter the plate cost and find the price that hits your target margin.",
    ...
    "mailLead": "If your domain has no SPF, DKIM and DMARC, your sales proposal has a strong chance of landing in the customer's spam folder — and you never find out. Enter the domain and see in seconds.",
    ...
    "ctaMail": "Want this fixed without touching DNS yourself? SPF, DKIM and DMARC setup is part of the corporate email package.",
    "ctaPrice": "Want this calculated automatically, per dish and wired to your inventory? That's exactly what MiseOn does.",
