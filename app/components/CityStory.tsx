...
export default function CityStory() {
  ...
  return <section className="city-story"><div className="wrap">
    ...
    <Link className="personal-link" href={localePath("/servicos#audiovisual", lang)}>{pt ? "Conhecer os serviços de foto e vídeo" : "Explore photo and video services"}<ArrowUpRight size={18}/></Link>
  </div></section>;
}
